page 50100 "Test OAuth2 Flows"
{
    ...
    var
        ...
        APICalls: Codeunit "IMP Management";
        ...
        ResourceURL_Txt: Label 'https://graph.microsoft.com/';
        AadTenantId: Text;
        Result: Text;
    ...
    begin
        OAuth2.AcquireTokenWithClientCredentials(ClientId, ClientSecret, MicrosoftOAuth2Url, RedirectURL, ResourceURL_Txt, AccessToken);
    ...
    var
        ...
        Scopes: List of [Text];
    begin
        Scopes.Add(ResourceURL_Txt);
        OAuth2.AcquireTokenByAuthorizationCode(ClientId, ClientSecret, MicrosoftOAuth2Url, RedirectURL, Scopes, PromptInteraction::"Admin Consent", AccessToken, AuthError);
    ...
    var
        Scopes: List of [Text];
    begin
        Scopes.Add(ResourceURL_Txt + '.default');
    ...
    var
        ...
        Scopes: List of [Text];
    begin
        Scopes.Add(ResourceURL_Txt + 'user.read');
    ...
    begin
        ...
        if AuthError = '' then
            ...
            ErrorMessage := 'Authorization has failed with the error: ' + AuthError + '.';
    end;
