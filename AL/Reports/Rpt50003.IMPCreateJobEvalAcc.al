report 50003 "IMP Create Job Eval.Acc."
{
    ...
    dataset
    {
        dataitem(JobInvoiceHeader; "IMP Job Consulting Inv. Header")
        {
            ...
            begin
                ...
                IF l_JobTask.FINDSET THEN
                    REPEAT
                        IF NOT l_tmp_JobEvalLine.GET(l_JobTask."Job No.", Month, Year, l_JobTask."Job Task No.", '') THEN BEGIN
                            ...
                            l_tmp_JobEvalLine."Job No." := "Job No.";
                ...
                l_JobJnlLine.SETRANGE("Job No.", "Job No.");
                IF l_JobJnlLine.FINDSET THEN
                    REPEAT
                        IF l_JobTask.GET("Job No.", l_JobJnlLine."Job Task No.") THEN BEGIN
                            IF NOT l_tmp_JobEvalLine.GET("Job No.", Month, Year, l_JobJnlLine."Job Task No.", '') THEN BEGIN
                                l_tmp_JobEvalLine.INIT;
                                l_tmp_JobEvalLine."Job No." := "Job No.";
                                l_tmp_JobEvalLine.Month := Month;
                                l_tmp_JobEvalLine.Year := Year;
                                ...
                                l_JobPlanning.SETRANGE("Job No.", "Job No.");
                                l_JobPlanning.SETRANGE("Job Task No.", l_JobTask."Job Task No.");
                                IF l_JobPlanning.FINDSET THEN
                                    REPEAT
                                        l_tmp_JobEvalLine.Budget := l_tmp_JobEvalLine.Budget + l_JobPlanning.Quantity;
                                    ...
                                    UNTIL l_JobPlanning.NEXT = 0;
                            END;
                            IF l_JobLine.GET("Job No.", Year, Month, l_JobJnlLine."Journal Template Name", l_JobJnlLine."Journal Batch Name", l_JobJnlLine."Line No.")
                            THEN BEGIN
